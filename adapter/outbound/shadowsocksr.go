...
import (
	...
	"github.com/TokenPLS/Hako/transport/shadowsocks/shadowstream"
	"github.com/TokenPLS/Hako/transport/socks5"
	"github.com/TokenPLS/Hako/transport/ssr/obfs"
	"github.com/TokenPLS/Hako/transport/ssr/protocol"
)
...
func (ssr *ShadowSocksR) ListenPacketContext(ctx context.Context, metadata *C.Metadata) (C.PacketConn, error) {
	...
	addr, err := resolveUDPAddr(ctx, "udp", ssr.addr, ssr.prefer, dialer.IsPhysicalDialer(ssr.dialer))
	if err != nil {
		return nil, err
	}
