module github.com/TokenPLS/Hako/bind/hako
...
require (
	...
	github.com/TokenPLS/Hako v1.19.31
...
require (
	...
	github.com/easytier/easytier/easytier-go v0.0.0-20260918161347-e313ba8efb84 // indirect
...
replace github.com/TokenPLS/Hako => ../../

// Apple configuration revisions are immutable and explicitly activated.
// Avoid filesystem watchers and their descriptor/goroutine lifecycle in NE.
replace github.com/metacubex/fswatch => ../../third_party/fswatch-noop

// Keep gomobile on Hako's Darwin dispatcher teardown fix.
replace github.com/metacubex/sing-tun => ../../third_party/sing-tun

// Keep gomobile on Hako's full-duplex ReTLS debug-race fix. Replacements are
// not inherited through the local mihomo module replacement above.
replace github.com/metacubex/restls-client-go => ../../third_party/restls-client-go

// Keep gomobile on Hako's smux asynchronous payload-ownership fix.
replace github.com/metacubex/smux => ../../third_party/smux

// Keep the gomobile main module on the same protobuf implementation as the
// vendored mihomo root module. Replacements are not inherited through the
// local mihomo replace above.
